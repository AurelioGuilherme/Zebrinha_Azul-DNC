...
def view():
    st.subheader('Funções:')

    
    st.write('**`insert_city(conn, city_name, latitude, longitude):`**')
    ...
    st.write('**`insert_pessoas(conn, NOME):`**')
    with st.expander('**Exibir código:**'):
        st.code('''
    ...
    st.write('**`insert_clima(conn, CONDICAO_CLIMATICA):`**')
    with st.expander('**Exibir código:**'):
        st.code('''
    ...
    st.write('**`insert_viagem(conn, NOME, data, ENDERECO_ORIGEM, ENDERECO_DESTINO, distancia, tempo_viagem):`**')
    with st.expander('**Exibir código:**'):
        st.code('''
    ...
    st.write('**`insert_historico_clima(conn, data, cidade, condicao_climatica, temperatura, sensacao_termica):`**')
    with st.expander('**Exibir código:**'):
        st.code('''
